...
module.exports = ({ storiesOf, action }) => {
  return storiesOf('Comment', module)
    ...
    .add('Create Form', () => {
        ...
        return <CommentForm {...commentProps}></CommentForm>
    })  


    // .add('Create Form', () => {

    //     class CommentFormTest extends Component {
    ...
    //         render(){
    //             return <CommentForm {...this.state.commentProps}></CommentForm>
    //         }
    //     }


    //     return <CommentFormTest></CommentFormTest>
    // })  
